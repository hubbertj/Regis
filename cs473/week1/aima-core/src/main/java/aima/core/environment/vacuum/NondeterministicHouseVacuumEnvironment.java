 ...
 */
public class NondeterministicHouseVacuumEnvironment extends VacuumEnvironment {

    /**
     * Construct a vacuum environment with two locations, in which dirt is
     * placed at random.
     */
    public NondeterministicHouseVacuumEnvironment() {
        super();
    }

 
    public NondeterministicHouseVacuumEnvironment(LocationState locAState, LocationState locBState, 
    		LocationState locCState, LocationState locDState, 
    		LocationState locEState, LocationState locFState,
    		LocationState locGState, LocationState locHState) {
